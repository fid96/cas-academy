...
Via la plateforme racine (recommandé) :
...
Ouvrir http://localhost:8080/ → pack **Expert S&E**.

Ou directement : `se-atelier/index.html` (sous serveur local).
